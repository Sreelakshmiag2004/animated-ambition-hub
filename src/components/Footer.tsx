      ...
      <div className="container mx-auto px-6">
        ...
        >
          <div className="flex items-center gap-2 text-muted-foreground mb-4 md:mb-0">
            <span>© {currentYear} Yuvaraj S. Made with</span>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="p-3 rounded-full bg-cosmic/10 hover:bg-cosmic/20 text-cosmic transition-all duration-300 glow-cosmic"
          >

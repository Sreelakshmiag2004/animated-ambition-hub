...
const About = () => {
  const highlights = [
    ...
    },
    {
      ...
      description: "Skilled in containerization, CI/CD pipelines, and cloud infrastructure management"
    },
    {
      icon: Palette,
      title: "UI/UX Design",
    ...
    },
    {
      ...
      description: "Building efficient, scalable solutions with focus on performance and reliability"
    }
  ];
            ...
            <Card className="bg-card/50 backdrop-blur-sm cosmic-border">
              <CardContent className="p-8">
                <p className="text-lg leading-relaxed text-muted-foreground">
                  I'm a passionate <span className="text-cosmic font-semibold">DevOpster and Front-end Developer</span> based in Chennai, 
